...
public class RoleAssignPersonForm extends VerticalLayout {
  ...
  public void setData(Role role, List<Person> persons) {
    ...
    if (role != null && persons != null) {
      ...
      orgUnitTexField.setValue(roleInfos.toString());
  ...
  // Events
  public static abstract class OrgAssignPersonFormEvent extends ComponentEvent<RoleAssignPersonForm> {
    private final Role role;

    protected OrgAssignPersonFormEvent(RoleAssignPersonForm source, Role role) {
      super(source, false);
      this.role = role;
    }
  ...
  public static class CloseEvent extends OrgAssignPersonFormEvent {
    CloseEvent(RoleAssignPersonForm source) {
      super(source, null);
    }
  }
